...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECNOTIFSSTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECNOTIFSSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECNOTIFSSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECNOTIFSSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECNOTIFSSTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECNOTIFSSTATS actions', async () => {
      const expectedActions = [
        {
